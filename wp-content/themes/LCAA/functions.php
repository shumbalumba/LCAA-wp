...
function theme_scripts(){
    ...
    if ( !is_admin() ) {
        ...
        wp_deregister_script('jquery');
				wp_register_script('jquery', ASSETS_URL . '/assets/jquery-1.12.4.min.js', false, false, true);
        wp_register_script('bootstrap', ASSETS_URL . '/assets/bootstrap.min.js', false, false, true);
        wp_register_script('js_main', ASSETS_URL . '/assets/lcaa.min.js', array('jquery', 'bootstrap'), '1.0', true);
...
function theme_stylesheets(){
	...
	$styles_path = ASSETS_URL . '/assets/styles/main.css';

	if( $styles_path ) {
	    wp_register_style('bootstrap', ASSETS_URL . '/assets/styles/bootstrap.min.css',  false, 'all');
        wp_register_style('fontawesome', 'https://cdnjs.cloudflare.com/ajax/libs/font-awesome/4.7.0/css/font-awesome.min.css',  false, 'all');
		wp_register_style('main-css', ASSETS_URL . '/assets/styles/main.css', array('bootstrap', 'fontawesome'), false, 'all');
...
$sidebars = array( 'Language Widgets', 'Archive Widgets', 'Read-more Widget', 'Footer-text widget', 'Search-text widget' );
